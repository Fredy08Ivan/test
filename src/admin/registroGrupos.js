      ...
      <center>
        <div id="container">
          ...
          <form onSubmit={send}>
            ...
            <div class="telephone">
              <label for="validationCusto02" className="form-label"></label>
              <input
                type="text"
                className="form-control"
            ...
            <div class="subject">
              <label for="validationCustom04" className="form-label"></label>
              <select
        ...
        <br />
        <div>
          <Link className="text-ref" to="/principal">
